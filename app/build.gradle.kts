...
android {
    ...
    defaultConfig {
        applicationId = "com.example.scrobblerdemo3"
...
dependencies {
    ...
    api("com.google.accompanist:accompanist-insets:0.8.1")
    api("com.google.accompanist:accompanist-coil:0.8.1")

    api("androidx.datastore:datastore-preferences:1.0.0-beta01")

    api("androidx.hilt:hilt-lifecycle-viewmodel:1.0.0-alpha03")
    api("androidx.hilt:hilt-navigation-fragment:1.0.0-beta01")

    api("androidx.hilt:hilt-navigation-compose:1.0.0-alpha01")

    api("com.dropbox.mobile.store:store4:4.0.0")
